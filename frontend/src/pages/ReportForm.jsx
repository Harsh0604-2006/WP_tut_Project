...
const crops = ["Wheat", "Rice", "Cotton", "Tomato", "Potato", "Cucumber"];
const symptoms = [
  "Leaf spots (yellow/brown/black)",
  "Yellowing leaves",
  "Wilting",
  "Leaf curling",
  "White/gray powdery coating",
  "Stunted growth",
  "Rotting stem/root",
  "Holes in leaves",
  "Discoloration of fruit/grain",
];
